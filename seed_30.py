...
def seed():
    ...
    # Obtener un seller_id o crear uno si no hay
    ...
    productos_ejemplo = [
        # Merch
        ("Playera Nirvana Nevermind", "Playera 100% algodon de la portada del album.", 350.00, "https://m.media-amazon.com/images/I/61H4B7aQoHL._AC_UX569_.jpg", "merch", "S, M, L, XL"),
        ("Sudadera Arctic Monkeys", "Sudadera oficial AM.", 600.00, "https://m.media-amazon.com/images/I/61k8Y+0nToL._AC_UY879_.jpg", "merch", "M, L"),
        ("Taza The Beatles", "Taza de ceramica Abbey Road.", 150.00, "https://m.media-amazon.com/images/I/51rY5zP7XvL._AC_.jpg", "merch", "Unitalla"),
        ("Gorra Red Hot Chili Peppers", "Gorra bordada con logo.", 250.00, "https://m.media-amazon.com/images/I/61oZ-9kXyUL._AC_UX679_.jpg", "merch", "Unitalla"),
        ("Playera Pink Floyd", "Playera Dark Side of the Moon.", 300.00, "https://m.media-amazon.com/images/I/61-9r8Jm6AL._AC_UX679_.jpg", "merch", "S, M, XL"),
        ("Póster Metallica", "Poster Ride the Lightning 60x90cm.", 120.00, "https://m.media-amazon.com/images/I/71rB588fV-L._AC_SY879_.jpg", "merch", "Unitalla"),
        ("Llavero Queen", "Llavero de metal con logo clasico.", 80.00, "https://m.media-amazon.com/images/I/71eU2MvGZHL._AC_SX679_.jpg", "merch", "Unitalla"),
        ("Mochila Gorillaz", "Mochila Demon Days.", 700.00, "https://m.media-amazon.com/images/I/71eE7YfT9FL._AC_UX679_.jpg", "merch", "Unitalla"),
        ("Playera The Strokes", "Is This It merch.", 300.00, "https://m.media-amazon.com/images/I/61XzM1vA-zL._AC_UX569_.jpg", "merch", "M, L, XL"),
        ("Calcetines David Bowie", "Calcetines Aladdin Sane.", 100.00, "https://m.media-amazon.com/images/I/71I6L5H3DNL._AC_UX679_.jpg", "merch", "Unitalla"),
    ...
    cursor.close()
    cnx.close()
    print(f"Seeded {len(productos_ejemplo)} products successfully.")
